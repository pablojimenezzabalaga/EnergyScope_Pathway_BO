...
class AmplGraph:
    ...
    def graph_gwp_per_sector(self):
        ...
        order_entry = ['MOB_PRIVATE','MOB_PUBLIC','MOBILITY_FREIGHT','MOB_FREIGHT_AIR', 'ELECTRICITY',
                       'HEAT_HIGH_T','HEAT_LOW_T_DHN','HEAT_LOW_T_DECEN',
                       'HVC','METHANOL','AMMONIA','COOKING', 'MECHANICAL_ENERGY_COMM', 'MECHANICAL_ENERGY_IND', 'MECHANICAL_ENERGY_MOV_AGR', 'MECHANICAL_ENERGY_FIX_AGR', 'MECHANICAL_ENERGY_MIN', 'MECHANICAL_ENERGY_FISH_OTHERS']
        ...
        for scenario in gwp_per_sector['Scenario'].unique():
            ...
            # Ajustar las divisiones del eje X basándose en los valores de 'Years'
            fig.update_xaxes(tickvals=gwp_per_sector['Years'].unique())
